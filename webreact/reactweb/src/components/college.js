              ...
              <div className="placefortest">
                <div className="box">
                  ...
                  <div className="eyeandown">
                    ...
                    <div className="downn">
                      <i className="fa-solid fa-download"></i> <span>4002</span>
                    </div>
                  </div>
                ...
                <div className="box">
                  <div>
                    <p>
                      Đề thi tham khảo kỳ thi THPT Quốc Gia Môn Ngữ Văn năm 2022
                      của Bộ Giáo Dục và Đào Tạo có hướng dẫn giải chi tiết
                    </p>
                  </div>
                  <div className="title">
                ...
                <div className="box">
                  <div>
                    <p>
                      Đề thi tham khảo kỳ thi THPT Quốc Gia Môn Hóa học năm 2022
                      của Bộ Giáo Dục và Đào Tạo có hướng dẫn giải chi tiết
                    </p>
                  </div>
                  <div className="title">
                ...
                <div className="box">
                  <div>
                    <p>
                      Đề thi tham khảo kỳ thi THPT Quốc Gia Môn Vật Lí năm 2022
                      của Bộ Giáo Dục và Đào Tạo có hướng dẫn giải chi tiết
                    </p>
                  </div>
                  <div className="title">
                ...
                <div className="box">
                  <div>
                    <p>
                      Đề thi tham khảo kỳ thi THPT Quốc Gia Môn Địa Lí năm 2022
                      của Bộ Giáo Dục và Đào Tạo có hướng dẫn giải chi tiết
                    </p>
                  </div>
                  <div className="title">
                ...
                <div className="box">
                  <div>
                    <p>
                      ...
                      2022 của Bộ Giáo Dục và Đào Tạo có hướng dẫn giải chi tiết
                    </p>
                  </div>
                  <div className="title">
                    <i className="fa-regular fa-folder-open"> </i>
                ...
                <div className="box">
                  <div>
                    <p>
                      Đề thi tham khảo kỳ thi THPT Quốc Gia Môn Lịch Sử năm 2022
                      của Bộ Giáo Dục và Đào Tạo có hướng dẫn giải chi tiết
                    </p>
                  </div>
                  <div className="title">
